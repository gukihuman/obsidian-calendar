...
// v4/accounting-calendar?filters=1,[3,[1,[2,[1,3]]]]
...
Поле **id** используется для апи запросов на бэк и в адресной строке на фронте для сохранения фильтров.
...
// так выглядит адрес фронта с фильтрами
"v4/accounting-calendar?filters=dayOff,[buhEvents,[reportTypes,[ecology,alcogol]]"
```
